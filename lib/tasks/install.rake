...
namespace :gsass do
  ...
  task :install, [:sass_path] do |t, args|
    ...
    FileUtils.mkdir_p("#{Rails.root}/#{args.sass_path}/gsass")
    FileUtils.cp_r("#{source_root}/app/assets/stylesheets/.", "#{Rails.root}/#{args.sass_path}/gsass", { :preserve => true })
    Find.find("#{Rails.root}/#{args.sass_path}/gsass") do |path|
